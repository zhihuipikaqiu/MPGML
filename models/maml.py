...
"""Differentiable MAML cloning and adaptation, adapted from learn2learn.

MPGML uses full-model adaptation. The optional ordered-parameter ANIL interface
is retained for compatibility with the adapted implementation.
"""
...
def maml_update(model, lr, grads=None, adaptable_weights=None, anil=False):
    ...
    **Example**
    ...
    maml_update(model, lr=0.1, grads=grads)
    ~~~
    """
